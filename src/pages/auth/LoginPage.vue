<template>
                        ...
                        <div class="col-md-6 p-lg-5 p-4 d-flex flex-column justify-content-center">
                            ...
                            <form class="d-flex flex-column gap-2 mt-md-4" @submit.prevent="login" method="POST">
                                ...
                                <label class="fw-medium">Password</label>
                                    <input :type="showPassword ? 'text' : 'password'" v-model="form.password" class="form-control mb-2" placeholder="Enter your password" required/>
                            ...
                            <div class="text-center mt-3 text-muted small">
                                Don’t have an account yet? <a href="/register" class="fw-bold text-decoration-none text-success">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Components -->
    <LoadingModal :show="isLoading" message="Loggin in, please wait..."/>
